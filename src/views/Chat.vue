        ...
        <aside class="w-full lg:w-2/6 bg-gray-900 rounded-lg mr-5">
          <div class="max-w-full h-full w-full flex flex-col">
            <div class="flex p-10 justify-between items-center">
              <div class="text-2xl font-semibold text-white">Discussions</div>
              ...
              <div class="w-full space-y-10">
                ...
                <div class="cursor-pointer flex px-10">
                  <div class="mr-4 relative w-12">
                    <img
                      alt=""
                      class="rounded-full w-full mr-2"
                  ...
                  <div class="flex flex-col flex-1">
                    <div class="flex justify-between items-center">
                      ...
                      <div class="text-gray-600 text-xs">12:00</div>
                    </div>
        ...
        >
          ...
          <div
            ...
            class="
              ...
              overflow-y-scroll
              p-5
              scrollbar-thumb-color scrollbar-width
              space-y-5
            "
          >
            <!-- LEFT MESSAGE START -->
